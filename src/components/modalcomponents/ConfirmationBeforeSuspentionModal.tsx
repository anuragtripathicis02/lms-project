...
const ConfirmationBeforeSuspentionModal = ({ show, handleClose }: any) => {
  return (
    <Modal size="sm" show={show} onHide={handleClose} centered className="common-modal-sec report-modal-classify w-500 pt-4">
            ...
            <Modal.Body className="common-modal-body">
                <h2>Are You Sure?</h2>
                <p className='mb-24 pb-2'>Suspending your account will immediately end all active sessions across your devices once the suspension begins.</p>
                <button className='btn-theme btn-yellow w-100'>Confirm & Schedule</button>
            </Modal.Body>
...
export default ConfirmationBeforeSuspentionModal
