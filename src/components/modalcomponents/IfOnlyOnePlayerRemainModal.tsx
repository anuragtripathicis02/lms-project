...
import Cup from "../../../public/images/cup.gif";
...
const IfOnlyOnePlayerRemainModal = ({ show, handleClose }: any) => {
    return (
        <Modal size="sm" show={show} onHide={handleClose} centered className="common-modal-sec report-modal-classify w-500 pt-4">
            ...
            <Modal.Body className="common-modal-body announcements-modal text-center">
                ...
                <div className='announcements-modal-content'>
                    ...
                    <div className='cupImg mb-24'>
                        <Image src={Cup} alt=''/>
                    </div>
                    <p className='mb-24 text-congratulations'>Congratulations! You are the Last Man Standing for <b>AFL Season 2026</b></p>

                   <div className='mb-24 your-winning'>
                     <p className='mb-0'>Your Winning</p>
                    <h2 className='mb-0'><sub>A$</sub> 50,000</h2>
                   </div>
                    <p className='mb-40 text-withdraw-your-winnings'>Top below to withdraw your winnings</p>
...
export default IfOnlyOnePlayerRemainModal
