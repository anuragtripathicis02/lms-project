...
const SwitchYourPick = ({ show, handleClose }: any) => {
  return (
    <Modal size="sm" show={show} onHide={handleClose} centered className="common-modal-sec report-modal-classify w-500 pt-4">
            ...
            <Modal.Body className="common-modal-body">
                <h2>Switch your pick</h2>
                <p className='mb-24 pb-2'>Please confirm you are about to change your previous picked team</p>

                <div className='bank-list mb-24 previous-selection'>
                    <p className='mb-1 selection-title'>Previous Selection</p>
                ...
                <div className='bank-list mb-24 current-selection'>
                    <p className='mb-1 selection-title'>Current Selection</p>
                    <div className='bank-info-card'>
                        <div className='d-flex align-items-center'>
                            <div className='icon'>
                            ...
                            <div className='content-right'>
                                <h4 className="bank-name">Port Adelaide Power</h4>
                                <p className="institution-name">AFL Season 2026 | @Round-6 </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className='d-flex flex-column gap-2'>
                    ...
                    <button className='btn-theme btn-yellow'>Yes! Update My Pick</button>
                </div>
