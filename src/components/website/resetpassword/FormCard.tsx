            ...
            <div className='form-wrapper-main'>
                <div className='form-card-box'>
                    <div className='card-form-body'>
                        <p className='font-20 mb-mobile mb-40'>You're almost there. Enter a strong new password to secure your account and get back in.</p>

                <FloatingLabel  className="mb-3" controlId="floatingPassword" label="Create Password">
