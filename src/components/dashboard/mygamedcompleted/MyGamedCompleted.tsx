...
import GameUser from "../../../../public/images/game-user.png";

const MyGamedCompleted = () => {
  return (
                             ...
                             <div className='game-footer'>
                                <div className='d-flex align-items-center'>
                                    <div className='me-auto'>
                                        <div className='d-flex align-items-center'>
                                            <Image src={GameUser} className='rounded-5' alt='' />
                                            <div className='flex-grow1'>
                                                <h4 className='red-title'>@johnd123</h4>
                                                <p>Game Winner</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='ms-auto text-end'>
                                        <h4>Completed on</h4>
                                        <p className='mb-0'>25 Oct 2025 @01:30 AM</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className='d-flex'>
                                    ...
                                    <div className='game-content-right'>
                                        ...
                                        <ul className='d-flex align-items-center'>
                                            <li>AFL</li>
                                            <li>LMS</li>
                                            <li><b>Round 6</b> (Waiting for result)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
export default MyGamedCompleted
