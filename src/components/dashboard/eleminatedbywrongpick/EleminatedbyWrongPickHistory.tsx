                ...
                <div className='card-round-rignt'>
                        <div className='card-simple card-red'>
                            ...
                            <div className='d-flex gap-pre-match-20 align-items-stretch'>
                                ...
                                <div className="match-winner highlight gray-bg">
                                    <div className="card-sticker">Winner</div>
                                    <Image src={TeamLogo16} alt='' />
                        ...
                        <div className='d-flex align-items-center'>
                                <div className='me-auto logo-win'>
                                    <div className='d-flex align-items-center gap-2'>
                                        <Image src={TeamLogo15} alt='' /> No Pick Submitted!
                                    </div>
                                </div>
                                <div className='ms-auto'>
                                    <span className='chip-wedge'>Your pick didn’t win</span>
                                </div>
                            </div>
                        </div>
                </div>
